...
import db.Conexion;
/**
 * Clase TipoInversionDAO para manejar las operaciones de acceso a datos relacionadas
 * con la entidad TipoInversion.
 * Permite insertar, actualizar, eliminar y listar tipos de inversión en la base de datos.
 */
