...
/**
 * Clase TipoMovimientoDAO que gestiona las operaciones CRUD para los tipos de movimiento en la base de datos.
 */
public class TipoMovimientoDAO {
    ...
    /**
     * Inserta un nuevo tipo de movimiento en la base de datos usando un procedimiento almacenado.
     *
     * @param tipo Objeto TipoMovimiento que contiene la descripción del tipo de movimiento.
    ...
    /**
     * Actualiza un tipo de movimiento existente en la base de datos usando un procedimiento almacenado.
     *
     * @param tipo Objeto TipoMovimiento con el código y la nueva descripción a actualizar.
     * @throws SQLException Si ocurre un error al ejecutar la operación.
     */
    ...
    /**
     * Recupera una lista con todos los tipos de movimiento desde la vista Vista_Tipo_Movimiento.
     *
