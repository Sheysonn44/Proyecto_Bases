...
/**
 * Clase TipoDeudaDAO que gestiona las operaciones CRUD sobre los tipos de deuda en la base de datos.
 */
public class TipoDeudaDAO {
     ...
     *
     * @param tipo Objeto TipoDeuda que contiene la descripción del tipo de deuda a insertar.
     ...
     *
     * @param tipo Objeto TipoDeuda con el código y la nueva descripción del tipo de deuda.
     * @throws SQLException Si ocurre un error durante la ejecución del procedimiento almacenado.
     */
    ...
    /**
     * Elimina un tipo de deuda de la base de datos utilizando un procedimiento almacenado.
     *
    ...
    /**
     * Obtiene una lista con todos los tipos de deuda desde la vista correspondiente en la base de datos.
     *
